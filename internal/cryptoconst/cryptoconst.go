...
// file: tls-parameters-4.csv, date: 2025-09-27T09:18:22Z
...
const (
	...
	TLS_SM4_GCM_SM3                               CipherSuite = 0x00C6
	TLS_SM4_CCM_SM3                               CipherSuite = 0x00C7
	...
	TLS_ECCPWD_WITH_AES_128_GCM_SHA256            CipherSuite = 0xC0B0
	TLS_ECCPWD_WITH_AES_256_GCM_SHA384            CipherSuite = 0xC0B1
	TLS_ECCPWD_WITH_AES_128_CCM_SHA256            CipherSuite = 0xC0B2
	TLS_ECCPWD_WITH_AES_256_CCM_SHA384            CipherSuite = 0xC0B3
	TLS_SHA256_SHA256                             CipherSuite = 0xC0B4
	TLS_SHA384_SHA384                             CipherSuite = 0xC0B5
	TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC  CipherSuite = 0xC100
	TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC       CipherSuite = 0xC101
	TLS_GOSTR341112_256_WITH_28147_CNT_IMIT       CipherSuite = 0xC102
	TLS_GOSTR341112_256_WITH_KUZNYECHIK_MGM_L     CipherSuite = 0xC103
	TLS_GOSTR341112_256_WITH_MAGMA_MGM_L          CipherSuite = 0xC104
	TLS_GOSTR341112_256_WITH_KUZNYECHIK_MGM_S     CipherSuite = 0xC105
	TLS_GOSTR341112_256_WITH_MAGMA_MGM_S          CipherSuite = 0xC106
	...
	TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256     CipherSuite = 0xCCAD
	TLS_RSA_PSK_WITH_CHACHA20_POLY1305_SHA256     CipherSuite = 0xCCAE
	TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256         CipherSuite = 0xD001
	TLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384         CipherSuite = 0xD002
	TLS_ECDHE_PSK_WITH_AES_128_CCM_8_SHA256       CipherSuite = 0xD003
	TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256         CipherSuite = 0xD005
)

var toCipherSuite = map[string]CipherSuite{
